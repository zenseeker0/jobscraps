...
class DatabaseConfig:
    ...
    def __init__(self, config_path: str = "/Users/jonesy/gitlocal/jobscrape/config/db_config.json", 
...
class JobDatabase:
    ...
    def _update_backup_manifest(self, backup_info: Dict) -> None:
        ...
        """
        manifest_path = "/Users/jonesy/gitlocal/jobscrape/Backups/DatabaseBackups/backup_manifest.json"
    ...
    def restore_backup(self, backup_filename: str) -> bool:
        ...
        """
        backup_path = f"/Users/jonesy/gitlocal/jobscrape/Backups/DatabaseBackups/{backup_filename}"
...
class DuplicateManager:
    ...
    def create_delete_ids_file(self, ids_to_delete: List[str], filename: str = "config/delete_ids.txt") -> None:
...
class JobSearchConfig:
    ...
    def __init__(self, config_path: str = "/Users/jonesy/gitlocal/jobscrape/config/job_search_config.json"):
...
class JobScraper:
    ...
    def __init__(self, config_path: str = "/Users/jonesy/gitlocal/jobscrape/config/job_search_config.json", 
                 db_config_path: str = "/Users/jonesy/gitlocal/jobscrape/config/db_config.json",
                 database_type: str = "production"):
    ...
    def delete_jobs_by_ids(self, ids_file: str = "/Users/jonesy/gitlocal/jobscrape/config/delete_ids.txt") -> None:
        """Delete jobs by their IDs from a file."""
        # Warn if running data deletion against production database
        if self.db.database_type == "production":
            print("⚠️  WARNING: Running data deletion against PRODUCTION database!")
    ...
    def delete_jobs_by_company(self, companies_file: str = "/Users/jonesy/gitlocal/jobscrape/config/delete_companies.txt") -> None:
    ...
    def delete_jobs_by_title(self, titles_file: str = "/Users/jonesy/gitlocal/jobscrape/config/delete_titles.txt") -> None:
...
def parse_args():
    ...
    parser.add_argument('--config', metavar='FILE', default='/Users/jonesy/gitlocal/jobscrape/config/job_search_config.json',
                       help='Path to job search configuration file (default: /Users/jonesy/gitlocal/jobscrape/config/job_search_config.json)')
    parser.add_argument('--db-config', metavar='FILE', default='/Users/jonesy/gitlocal/jobscrape/config/db_config.json',
                       help='Path to database configuration file (default: /Users/jonesy/gitlocal/jobscrape/config/db_config.json)')
...
def main():
    ...
    try:
        if args.backup:
            ...
            ids_file = args.delete_by_ids if args.delete_by_ids != 'default' else "/Users/jonesy/gitlocal/jobscrape/config/delete_ids.txt"
            scraper.delete_jobs_by_ids(ids_file)
        elif args.delete_by_company is not None:
            companies_file = args.delete_by_company if args.delete_by_company != 'default' else "/Users/jonesy/gitlocal/jobscrape/config/delete_companies.txt"
            scraper.delete_jobs_by_company(companies_file)
        elif args.delete_by_title is not None:
            titles_file = args.delete_by_title if args.delete_by_title != 'default' else "/Users/jonesy/gitlocal/jobscrape/config/delete_titles.txt"
