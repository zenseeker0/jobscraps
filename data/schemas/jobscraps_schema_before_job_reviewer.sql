...
DROP INDEX IF EXISTS public.idx_job_metadata_status;
DROP INDEX IF EXISTS public.idx_job_metadata_reviewed;
...
ALTER TABLE IF EXISTS ONLY public.job_user_metadata DROP CONSTRAINT IF EXISTS job_user_metadata_pkey;
ALTER TABLE IF EXISTS public.search_sessions ALTER COLUMN id DROP DEFAULT;
...
DROP TABLE IF EXISTS public.job_user_metadata;
...
--
-- Name: job_user_metadata; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.job_user_metadata (
...
--
-- Name: job_user_metadata job_user_metadata_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_user_metadata
    ADD CONSTRAINT job_user_metadata_pkey PRIMARY KEY (job_id);
...
--
-- Name: idx_job_metadata_reviewed; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_job_metadata_reviewed ON public.job_user_metadata USING btree (reviewed);


--
-- Name: idx_job_metadata_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_job_metadata_status ON public.job_user_metadata USING btree (status);
...
--
-- Name: search_history fk_search_sessions; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.search_history
    ADD CONSTRAINT fk_search_sessions FOREIGN KEY (session_id) REFERENCES public.search_sessions(id);
